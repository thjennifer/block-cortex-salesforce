...
*  Corrected the time dimension\_group **leads\_capture\_conversion.lead\_first\_response** to reference `LeadFirstResponseDatestamp` instead of `LeadFirstResponeDatestamp` from the SFDC reporting view `LeadsCaptureConversions`.
